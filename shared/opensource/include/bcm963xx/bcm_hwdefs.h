...
//<< [CTFN-SYS-017] Antony.Wu : Support Serial Number in NVRAM, 2011/11/11
/* Add Comtrend defined parameter here */
//<< [CTFN-WIFI-012] Antony.Wu : Set default authentication mode and and default Wireless key, 2011/11/25
#define NVRAM_WLAN_PASSWD_LEN		20
//>> [CTFN-WIFI-012] End
#define NVRAM_SERIAL_NUMBER_LEN		20

typedef struct{
/* Need to put new member in FIRST sequence in struct */
//<< [CTFN-WIFI-012] Antony.Wu : Set default authentication mode and and default Wireless key, 2011/11/25
	char szWlanPasswd[NVRAM_WLAN_PASSWD_LEN];
//>> [CTFN-WIFI-012] End
	char szSerialNumber[NVRAM_SERIAL_NUMBER_LEN+1];
}CT_NVRAM_DATA, *PCT_NVRAM_DATA;
//>> [CTFN-SYS-017] End
...
//<< [CTFN-SYS-017] Antony.Wu : Support Serial Number in NVRAM, 2011/11/11
    char chUnused[354-sizeof(CT_NVRAM_DATA)];
    CT_NVRAM_DATA ctData;
    unsigned long ulCheckSum;
//<< asdrick: fix NVRAM size that contain comtrend serial number from 1028 to 1024
...
//<< [CTFN-SYS-002] Jimmy Wu : show the full CFE version (include CT_RELEASE number), 2008/08/29
#define CFE_VERSION_SIZE             6 //5
//>> [CTFN-SYS-002] End
