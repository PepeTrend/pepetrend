...
enum bp_id {
  ...
  bp_ulDeviceOptions,
//<< [CTFN-WIFI-001] Jimmy Wu : support wireless button
...
//<< for VR-3025u Multi-DSL
unsigned char _96368M_1541N_phymap[BP_MAX_SWITCH_PORTS] = {0x01, 0x02, 0x03, 0x04};
static bp_elem_t g_96368M_1541N[] = {
  {bp_cpBoardId ,              .u.cp = "96368M-1541N"},
  ...
  //{bp_usExtIntrResetToDefault, .u.us = BP_EXT_INTR_0},
  {bp_usExtIntrResetToDefault, .u.us = BP_GPIO_34_AL},
  {bp_usExtIntrSesBtnWireless, .u.us = BP_EXT_INTR_1},
  ...
  {bp_usGpioCtInternetLed,     .u.us = BP_GPIO_5_AH},
  {bp_usGpioCtInternetFailLed, .u.us = BP_GPIO_31_AH},
  {bp_ucpEthPhyMap,            .u.ucp= _96368M_1541N_phymap},
  {bp_last}
};
//>> for VR-3025u Multi-DSL, End
...
static bp_elem_t g_96328A_1441N1[] = {
  {bp_cpBoardId,               .u.cp = "96328A-1441N1"},
...
static bp_elem_t * g_BoardParms[] = {g_bcm96328avng, g_bcm96328avngrP1, g_bcm96328avngr, g_bcm963281TAN, g_bcm963281TAN2, g_bcm963281TAN3, g_bcm963281TAN4, g_bcm963293epon, g_bcm963293epon_gphy, g_bcm963283_24tstbrd, g_bcm93715rv, 
//<< Add AR-5387un profile
g_96328A_1441N1, // AR-5387un
//>> End, Add AR-5387un profile
0};
#endif
...
// << Joba.Yang : For VR-3032u
unsigned char _963168m_1841n1_phymap[BP_MAX_SWITCH_PORTS] = {0x04, 0x01, 0x02, 0x03, 0x00}; 
static bp_elem_t g_963168m_1841n1[] = {
  {bp_cpBoardId ,              .u.cp = "963168M-1841N1"},
  {bp_ulDeviceOptions,         .u.ul = BP_DEVICE_OPTION_ENABLE_GMAC },
  {bp_usGpioOverlay,           .u.ul =(BP_OVERLAY_PHY |
                                       BP_OVERLAY_SERIAL_LEDS)},
  {bp_usGpioLedAdsl,           .u.us = BP_SERIAL_GPIO_3_AL},
  ...
  {bp_ulPhyId1,                .u.ul = 0x02},
  {bp_ulPhyId2,                .u.ul = 0x03},
//<< Joba Yang Change Wireless PA and modify the PhyId setting for VR-3032u
...
//<< [JAZ-026] Joba Yang : Support USB LED per Jazztel's specific  
  ...
  {bp_usGpioCtUSBFailLed,      .u.us = BP_SERIAL_GPIO_5_AL},
//>> [JAZ-026] End
  {bp_ucpEthPhyMap, 		   .u.ucp= _963168m_1841n1_phymap},
  {bp_last}
};
// >> Joba Yang : For VR-3032u
...
static bp_elem_t * g_BoardParms[] = {g_bcm96318A_1441N1, g_bcm96318sv, g_bcm96318ref, g_bcm96318ref_p300, g_bcm96318sv_serled, g_bcm96318sv_sersw, 0};
...
//<< Charles Wei: correction for wrong SROM patch which caused poor wireless performance
//<< Joba Yang Change Wireless PA and modify the PhyId setting for VR-3032u
//VR-3031u
...
//VR-3032u
//static WLAN_SROM_ENTRY wlan_patch_common_963168M_1841N1[] = {
static WLAN_SROM_ENTRY wlan_patch_unique_1841N1[] = {
    { 2,  0x05BB},
    { 65,  0x1204},
    { 97,  0xFF81},
    { 98,  0x1860},
...
//>> Joba Yang End
//>> Charles Wei: End, correction for wrong SROM patch which caused poor wireless performance
...
//<< Charles Wei: correction for wrong SROM patch which caused poor wireless performance
//VR-3031u
    {"963168M-1341N1",     0x6362, 220, wlan_patch_unique_1341N1,     wlan_patch_common_963268MBV},
//VR-3032u
//<< Joba Yang Change Wireless PA and modify the PhyId setting for VR-3032u
    {"963168M-1841N1",     0x6362, 220, wlan_patch_unique_1841N1,     wlan_patch_common_963268MBV},
//>> Joba Yang End
//>> Charles Wei: End, correction for wrong SROM patch which caused poor wireless performance
...
//<< Add AR-5387un profile
#if defined(_BCM96328_) || defined(CONFIG_BCM96328)
/* this is the patch to srom map for AR-5387un */
    {"96328A-1441N1",   43225, 115, wlan_patch_unique_96328A1441N1, wlan_patch_common_96328A1441N1},    
#endif
//>> End, Add AR-5387un Profile 
...
//<< Charles Wei: correction for wrong SROM patch which caused poor wireless performance
    ...
    {{"subpciids", 11, 0x5BB14e4},
    {"",       0,      0}}},
    /* this is the patch to boardtype(boardid) for 963168M-1841N1 */
    {"963168M-1841N1", 0x435f14e4, 64,
    {{"subpciids", 11, 0x5BB14e4},
    {"",       0,      0}}},
//>> Charles Wei: End, correction for wrong SROM patch which caused poor wireless performance
#endif
