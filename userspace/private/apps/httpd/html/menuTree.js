...
//<< [BCMBG-MISC-022] Fix the ugly Web for Power Management page in Advanced Setup menu, 2011/06/22
...
function drawItem()
{
  ...
  docW = docW + "<tr>"
  docW = docW + "<td class='menuCell' valign=middle nowrap width=100%>"
//<< [BCMBG-MISC-022] Fix the ugly Web for Power Management page in Advanced Setup menu, 2011/01/24
  if (this.desc.length <= 16) {
