...
//<< [CTFN-NRUT-002] Leo Ting :  Support DHCP option 121 for DHCP client
	...
	{"clsrouter",	OPTION_IP | OPTION_LIST,	0x79},
...
//<< [JAZ-DHCP-001] Use DSL Forum IANA Enterprise Number, 2012/11/18
//  *(unsigned int*)(optionData+VENDOR_OPTION_ENTERPRISE_OFFSET) = (unsigned int)VENDOR_BRCM_ENTERPRISE_NUMBER;
  *(unsigned int*)(optionData+VENDOR_OPTION_ENTERPRISE_OFFSET) = (unsigned int)VENDOR_DSLFORUM_ENTERPRISE_NUMBER;
//>> [JAZ-DHCP-001] End
