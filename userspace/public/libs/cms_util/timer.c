...
//<< [JAZ-DNS-005-2] evan : improve the DNS query sequence/retry timer of NTP/ACS (TTS3221), 2013.03.15
#ifdef DMP_X_BROADCOM_COM_IPV6_1
CmsRet cmsTmr_replaceIfSooner2(void *handle, CmsEventHandler func, void *ctxData, UINT32 ms, const char *name)
{
   const CmsTimerHandle *tmrHandle = (const CmsTimerHandle *) handle;
   CmsTimerEvent *tmrEvent;
   UBOOL8 found=FALSE;
