...
int cmsLog_readLitePartial(int ptr, char* buffer)
{
   return (oal_readLiteLogPartial(ptr, buffer));
}

int cmslog_readLite(int ptr, char* buffer)
{
   return (oal_readLogLite(ptr, buffer));
}
//>> Joba Yang End
