...
//<< [JAZ-TR69-007] David: Update Hosts table (add static hosts / delete DHCP expired hosts), 2012/02/10
   CMS_MSG_CT_POLLING_HOST_UPDATE               = 0x10000282, /**< Sent from ct_polling to ssk to trigger static lan hosts update */
   CMS_MSG_CT_POLLING_LEASE_UPDATE              = 0x10000283, /**< Sent from ct_polling to ssk to trigger expired leases update */
//>> [JAZ-TR69-007] End
