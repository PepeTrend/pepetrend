...
typedef struct
{
    ...
    char *    ftpUserName;	/**< FtpUserName */
    char *    ftpPassword;	/**< FtpPassword */
} LoginCfgObject;
...
/*! \brief Obj struct for InternetGatewayDevice.X_COMTREND_COM_AppCfg.EmailCfg.
 *
 * MDMOID_EMAIL_CFG 34
 */
typedef struct
{
    ...
    char *    fromEmailAddress;	/**< FromEmailAddress */
    char *    toEmailAddress;	/**< ToEmailAddress */
    char *    smtpServerAddress;	/**< SmtpServerAddress */
    UINT32    smtpServerPort;	/**< SmtpServerPort */
    char *    smtpAccount;	/**< SmtpAccount */
    char *    smtpPassword;	/**< SmtpPassword */
    UINT32    intervalTime;	/**< IntervalTime */
    UBOOL8    syslogFullEmail;	/**< onSyslogFullEmail */
    UBOOL8    authFail;	/**< onAuthFail */
    UBOOL8    fwUpgrade;	/**< onFwUpgrade */
    UBOOL8    enableSSL;	/**< EnableSSL */
} EmailCfgObject;

/*! \brief _EmailCfgObject is used internally to represent EmailCfgObject */
typedef EmailCfgObject _EmailCfgObject;
 ...
 *
 * MDMOID_Q_MGMT_CLASSIFICATION 46
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_LAN_IP_INTF_FIREWALL_EXCEPTION 57
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_DHCP_CONDITIONAL_SERVING 59
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_STATIC_I_PV6_NEIGHBOR 66
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_LAN_WLAN_ASSOCIATED_DEVICE_ENTRY 72
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_LAN_WLAN_PRE_SHARED_KEY 74
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_LAN_MOCA_INTF_STATUS 89
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_DSL_INTF_STATS_TOTAL 101
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_DSL_INTF_STATS_SHOWTIME 102
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_DSL_INTF_STATS_CURRENT_DAY 103
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_DSL_INTF_STATS_QUARTER_HOUR 104
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_DSL_TEST_PARAMS 105
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_MOCA_INTF_STATUS 111
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_MOCA_INTF_STATS 112
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_EPON_INTF_STATS 114
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_L2TP_AC_INTF_CONFIG 115
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_PON_INTF_STATUS 117
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_DSL_PROPRIETARY_DIAG 119
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_DSL_DIAG_NON_LINEARITY 121
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_ATM_F4_END_TO_END_LOOPBACK_DIAG 123
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_ATM_F4_LOOPBACK_DIAG 124
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_ATM_F5_END_TO_END_LOOPBACK_DIAG 125
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_ATM5_LOOPBACK_DIAG 130
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_L2TP_AC_LINK_CONFIG 133
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
...
typedef struct
{
...
#endif
#ifdef DMP_X_BROADCOM_COM_IPV6_1
    char *    X_JAZZTEL_COM_ExternalIPv6Address;	/**< X_JAZZTEL_COM_ExternalIPv6Address */
#endif
#ifdef DMP_X_BROADCOM_COM_IPV6_1
...
#endif
#ifdef DMP_X_BROADCOM_COM_IPV6_1
    char *    X_JAZZTEL_COM_IPv6SitePrefix;	/**< X_JAZZTEL_COM_IPv6SitePrefix */
#endif
#ifdef DMP_X_BROADCOM_COM_IPV6_1
    ...
    UBOOL8    X_JAZZTEL_COM_RemoteManagement;	/**< X_JAZZTEL_COM_RemoteManagement */
} WanIpConnObject;
 ...
 *
 * MDMOID_WAN_PPP_CONN_PORTMAPPING 143
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_PPP_CONN_PORT_TRIGGERING 144
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_PPP_CONN_FIREWALL_EXCEPTION 145
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_L3_FORWARDING_ENTRY 148
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_I_PV6_L3_FORWARDING 149
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
    char *    defaultConnectionService;	/**< DefaultConnectionService */
    UINT32    forwardNumberOfEntries;	/**< ForwardNumberOfEntries */
    char *    X_COMTREND_COM_ActiveDefaultGateway;	/**< X_COMTREND_COM_ActiveDefaultGateway */
 ...
 *
 * MDMOID_I_PV6_L3_FORWARDING_ENTRY 150
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_CALL_NEW_FLAG 162
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_CALL_NUMBER_OF_MISSED_CALLS 163
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_CALL_DATE_TIME 166
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_CALL_LINE_NAME 167
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_INTERNAL_NAME_LIST 170
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_TERMINAL_NUMBER 171
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_INTERNAL_NAME 172
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_CONTACT_FIRST_NAME 175
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_CONTACT_NUMBER 176
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_CONTACT_MELODY 177
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_CONTACT_LINE_ID 178
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_DECT_SUPPORT_LIST 179
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_PROF_PROVIDER 185
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_PROF_SIP_SUBSCRIBE 187
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_PROF_RTP_SRTP 190
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_LINE_CALLING_FEATURES 194
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_LINE_PROCESSING 195
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_LINE_CODEC_LIST 197
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_LINE_DECT_LINE_ID 201
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_LINE_ATTACHED_HANDSET 202
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_LINE_DIALING_PREFIX 204
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_LINE_BLOCKED_NUMBER 206
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_LINE_MULTI_CALL_MODE 207
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_LINE_INTRUSION_CALL 208
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_LINE_CALL_FORWARDING 210
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_PHY_INTF_TESTS 212
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_DECT_SYSTEM_SETTING 216
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_DECT_PIN_CODE 218
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_DECT_CLOCK_MASTER 219
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_DECT_RESET_BASE 220
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_DECT_FIRMWARE_VERSION 221
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_DECT_HARDWARE_VERSION 222
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_ACCESS_TIME_RESTRICTION 226
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_DEBUG_PORT_MIRRORING_CFG 233
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAPI_AS_CERTIFICATE 237
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAPI_ISSUED_CERTIFICATE 238
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_EQUIPMENT_MANAGEMENT 249
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_PORT_MAPPING_PACKAGE_G 257
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GEM_PORT_NETWORK_CTP 261
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GEM_INTERWORKING_TP 262
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MULTICAST_GEM_INTERWORKING_TP 263
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GEM_INTERWORKING_TP_MULTICAST_ADDRESS_TABLE 264
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GEM_PORT_PM_HISTORY_DATA 265
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GAL_ETHERNET_PROFILE 266
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GAL_ETHERNET_PM_HISTORY_DATA 267
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_FEC_PM_HISTORY_DATA 268
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_LAYER2_DATA_SERVICES 269
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MAC_BRIDGE_SERVICE_PROFILE 270
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_BC_MAC_BRIDGE_SERVICE_PROFILE 271
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MAC_BRIDGE_CONFIG_DATA 272
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MAC_BRIDGE_PM_HISTORY_DATA 273
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MAC_BRIDGE_PORT_CONFIG_DATA 274
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MAC_BRIDGE_PORT_DESIGNATION_DATA 275
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MAC_BRIDGE_PORT_FILTER_TABLE_DATA 276
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MAC_BRIDGE_PORT_FILTER_PRE_ASSIGN_TABLE 278
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MAC_BRIDGE_PORT_BRIDGE_TABLE_DATA 279
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MAC_BRIDGE_PORT_PM_HISTORY_DATA 281
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MAPPER_SERVICE_PROFILE 282
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_BC_MAPPER_SERVICE_PROFILE 283
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VLAN_TAGGING_FILTER_DATA 284
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VLAN_TAGGING_OPERATION_CONFIGURATION_DATA 285
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_EXTENDED_VLAN_TAGGING_OPERATION_CONFIGURATION_DATA 286
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_RECEIVED_FRAME_VLAN_TAGGING_OPERATION_TABLE 287
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MULTICAST_OPERATIONS_PROFILE 288
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_DYNAMIC_ACCESS_CONTROL_LIST_TABLE 289
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_STATIC_ACCESS_CONTROL_LIST_TABLE 290
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_LOST_GROUPS_LIST_TABLE 291
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MULTICAST_SUBSCRIBER_CONFIG_INFO 292
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MULTICAST_SUBSCRIBER_MONITOR 293
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_ACTIVE_GROUPS_LIST_TABLE 294
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_BC_MULTICAST_SUBSCRIBER_MONITOR 295
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MULTICAST_SUBSCRIBER 296
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_UPSTREAM_ETHERNET_FRAME_PM_HISTORY_DATA 297
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_DOWNSTREAM_ETHERNET_FRAME_PM_HISTORY_DATA 298
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_LAYER3_DATA_SERVICES 299
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_IP_HOST_CONFIG_DATA 300
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_BC_IP_HOST_CONFIG_DATA 301
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_IP_HOST_PM_HISTORY_DATA 302
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_IPV6_HOST_CONFIG_DATA 303
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_IPV6_CURRENT_ADDRESS_TABLE 304
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_IPV6_CURRENT_DEFAULT_ROUTER_TABLE 305
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_IPV6_CURRENT_DNS_TABLE 306
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_IPV6_CURRENT_ONLINK_PREFIX_TABLE 307
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_BC_IPV6_HOST_CONFIG_DATA 308
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_TCP_UDP_CONFIG_DATA 309
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_ETHERNET_PM_HISTORY_DATA 312
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_ETHERNET_PM_HISTORY_DATA2 313
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_ETHERNET_PM_HISTORY_DATA3 314
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VIRTUAL_ETHERNET_INTERFACE_POINT 315
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_SIP_AGENT_CONFIG_DATA 319
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VO_IP_MEDIA_PROFILE 321
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VO_IP_APP_SERVICE_PROFILE 324
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_FEATURE_ACCESS_CODES 325
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_NETWORK_DIAL_PLAN_TABLE 326
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_CALL_CONTROL_PM_HISTORY_DATA 329
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_RTP_PM_HISTORY_DATA 330
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_SIP_AGENT_PM_HISTORY_DATA 331
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_SIP_CALL_INIT_PM_HISTORY_DATA 332
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MGC_PM_HISTORY_DATA 334
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MOCA_ETHERNET_PM_HISTORY_DATA 341
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MOCA_INTERFACE_PM_HISTORY_DATA 342
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MOCA_INTERFACE_PM_HISTORY_DATA_NODE_TABLE 343
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_TRAFFIC_SCHEDULER_G 346
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GEM_TRAFFIC_DESCRIPTOR 347
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_AUTHENTICATION_SECURITY_METHOD 352
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_TR069_MANAGEMENT_SERVER 357
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
