...
//<< [CTFN-SYS-015] Jimmy Wu : Support to flash LED when CPE is upgrading the software
    ...
    {kLedPower, BpGetPowerLedGpio, BpGetPowerFailLedGpio},
#endif /* CTCONFIG_SYS_UPGRADE_FLASH_LED */
//>> [CTFN-SYS-015] End
//<< [CTFN-SYS-016-1] Camille : Support Internet LED for 963268 product, 2012/01/17
#if defined(CONFIG_BCM963268)
    {kLedInetOn, BpGetCtInternetLedGpio, NULL},
    {kLedInetFail, BpGetCtInternetFailLedGpio, NULL},
#endif
//>> [CTFN-SYS-016-1] End
//<< [JAZ-026] Joba Yang : Support USB LED per Jazztel's specific  
    {kLedUsbOn, BpGetCtUSBLedGpio, NULL},
    {kLedUsbFail, BpGetCtUSBFailLedGpio, NULL},
//>> [JAZ-026] End
    {kLedEnd, NULL, NULL}
};
...
//<< [CTFN-SYS-015] Jimmy Wu : Support to flash LED when CPE is upgrading the software
        ...
        if (pInfo->ledName == kLedPower)
        {
            ...
            setLed(&gLedCtrl[pInfo->ledName], kLedOn, kLedGreen);
